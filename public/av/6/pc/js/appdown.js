...
var appdw1 = '<div class="layui-waper"><div class="layer-iframe"><div class="layer-content layer_notice" ><a href="javascript:;" class="close" id="delay" style="visibility:hidden ">打开APP</a><a href="http://hg3535ios.oss-cn-hongkong.aliyuncs.co" class="link" id="delayy" style="visibility:hidden " >玩游戏</a></div></div></div>';//css 820
(function() {
    if (!isWeiXin()) {
