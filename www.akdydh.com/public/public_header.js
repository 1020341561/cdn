// 添加样式
document.write("<style>.public-header {background-color: #ff5a5e;position: fixed;top: 0;left: 0;width: 100%;z-index: 99999;}.public-header-inner {max-width: 1200px;height: 60px;display: flex;margin: 0 auto;justify-content: center;}.public-logo-link,.public-header-link {padding: 0;margin: 0;text-decoration: none;}.public-header-logo {padding: 5px 10px;width: auto;height: 50px;overflow: hidden;}.public-header-logo img {width: auto;height: 100%;}.public-header-list {display: flex;align-items: center;padding: 0 10px;color: #fff;cursor: pointer;height: 100%;}.public-header-list:hover {color: #000;background-color: #fff;}.public-header-list .iconBox {background-repeat: no-repeat;width: 30px;height: 25px;}.public-header-list .text {margin-left: 5px;}@media (max-width: 767px) {.public-visible-xs {display: block;}.public-hidden-xs {display: none;}.public-header {font-size: 12px;}.public-header-link {flex: 1;}.public-header-list {padding: 0;display: flex;justify-content: center;}.public-header-list .text {margin-left: 0;}}</style>")
// 添加元素
function addHeader() {
  $("body").prepend('<div class="public-header"><div class="public-header-inner"><a class="public-header-link" href="https://www.cav.ooo/?public_header"><div class="public-header-list"><div class="iconBox home public-hidden-xs"></div><div class="text">色情导航</div></div></a><a class="public-header-link" href="https://app.cav.ooo/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">成人APP</div></div></a><a class="public-header-link" href="https://www.xxlive.top/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">日本AV</div></div></a><a class="public-header-link" href="https://www.akdydh.com/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">电影导航</div></div></a><a class="public-header-link" href="https://www.dytt.xyz/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">电影天堂</div></div></a></div></div>');
}
// 初始化界面元素
function init(){
  var baseUrl="https://cdn.jsdelivr.net/gh/avhot/cdn@latest/www.cav.ooo/public/"; // 图片的baseUrl
  var _logo=$('<img src="'+baseUrl+'logo.png" />'); // logo
