...
// 添加元素
function addHeader() {
  $("body").prepend('<div class="public-header"><div class="public-header-inner"><a class="public-header-link" target="_blank" href="https://www.cav.dog/?public_header"><div class="public-header-list"><div class="iconBox home public-hidden-xs"></div><div class="text">色站导航</div></div></a><a class="public-header-link" target="_blank" href="https://app.cav.one/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">成人APP</div></div></a><a class="public-header-link" target="_blank" href="https://www.99re.site/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">日本AV</div></div></a><a class="public-header-link" target="_blank" href="https://www.akdydh.com/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">电影导航</div></div></a><a class="public-header-link" target="_blank" href="https://www.dytt.xyz/?public_header"><div class="public-header-list"><div class="iconBox public-hidden-xs"></div><div class="text">在线电影</div></div></a></div></div>');
}
// 初始化界面元素
function init(){
